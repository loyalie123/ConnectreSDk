...
class BaseCircleIndicator extends LinearLayout {
    ...
    private Config handleTypedArray(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray =
                context.obtainStyledAttributes(attrs, me.relex.circleindicator.R.styleable.BaseCircleIndicator);
        config.width =
                typedArray.getDimensionPixelSize(me.relex.circleindicator.R.styleable.BaseCircleIndicator_ci_width, -1);
        config.height =
                typedArray.getDimensionPixelSize(me.relex.circleindicator.R.styleable.BaseCircleIndicator_ci_height, -1);
        config.margin =
                typedArray.getDimensionPixelSize(me.relex.circleindicator.R.styleable.BaseCircleIndicator_ci_margin, -1);
        config.animatorResId = typedArray.getResourceId(me.relex.circleindicator.R.styleable.BaseCircleIndicator_ci_animator,
                me.relex.circleindicator.R.animator.scale_with_alpha);
        config.animatorReverseResId =
                typedArray.getResourceId(me.relex.circleindicator.R.styleable.BaseCircleIndicator_ci_animator_reverse, 0);
        config.backgroundResId =
                typedArray.getResourceId(me.relex.circleindicator.R.styleable.BaseCircleIndicator_ci_drawable,
                        me.relex.circleindicator.R.drawable.white_radius);
        config.unselectedBackgroundId =
                typedArray.getResourceId(me.relex.circleindicator.R.styleable.BaseCircleIndicator_ci_drawable_unselected,
                        config.backgroundResId);
        config.orientation = typedArray.getInt(me.relex.circleindicator.R.styleable.BaseCircleIndicator_ci_orientation, -1);
        config.gravity = typedArray.getInt(me.relex.circleindicator.R.styleable.BaseCircleIndicator_ci_gravity, -1);
        typedArray.recycle();
    ...
    public void initialize(Config config) {
        ...
        mIndicatorBackgroundResId =
                (config.backgroundResId == 0) ? me.relex.circleindicator.R.drawable.white_radius : config.backgroundResId;
    ...
    protected void addIndicator(int orientation, @DrawableRes int backgroundDrawableId,
        ...
        drawable.setColor(ConnectReApp.getThemeColor());

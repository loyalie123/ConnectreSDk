...
class LoaderView : LinearLayout {
    ...
    constructor(context: Context?, dotsRadius: Int, distanceMultiplier: Int, dotColor: Int) : super(
        context
    ) {
    ...
    private fun initView() {
        ...
        firstCircle = CircleView(context, dotsRadius, dotColor, drawOnlyStroke, strokeWidth)
        ...
        secondCircle = CircleView(context, dotsRadius, dotColor, drawOnlyStroke, strokeWidth)
        ...
        thirdCircle = CircleView(context, dotsRadius, dotColor, drawOnlyStroke, strokeWidth)
